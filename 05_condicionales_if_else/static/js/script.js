...
function Licencia(){
    ...
    let licencia = prompt("Tienes licencia para conducir?\nsí\nno")
    while (True){
        if(licencia=="sí" || licencia=="no"){
            break
    }
        else{
            alert("Valor incorrecto")
        licencia = prompt("Tienes licencia para conducir?\nsí\nno")
        }
    }
...
function Compa(){
    let num1=prompt("Dime una palabra");
    let num2=prompt("Dime otra palabra");
    let num1larg =num1.length
    let num2larg =num2.length
}
